...
register, error, setError, loading, setLoading
  ...
  const [username, setUsername] = React.useState(
    route.params ? Object.values(route.params)[0].email : '',
  );
  const [fullName, setFullName] = React.useState(
    route.params ? Object.values(route.params)[0].fullName : '',
  );
  const [description, setDescription] = React.useState(
    route.params ? Object.values(route.params)[0].description : '',
  );
  const [password, setPassword] = React.useState('');
  const [rePassword, setRePassword] = React.useState('');
  const [filePath, setFilePath] = React.useState(
    route.params ? {uri: Object.values(route.params)[0].avatar} : null,
  );
